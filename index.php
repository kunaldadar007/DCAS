...
<head>
	<title>Deogiri College Assignment System| Home Page</title>
...
<body>
			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>DCAS</a></h1>
					</div>
					<!-- navigation -->
	...
	<div class="testimonials-section">
		<div class="container">
			<h5 style="text-align:center" class="main-w3l-title">On a mission to teach Millions </h5>
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls" >
				<h2><a href="https://deogiricollege.org/" ><span class="fa fa-check-square-o" aria-hidden="true"></span >#DEOGIRIANS❤️</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p>&copy; 2025 DCAS | Deogiri College Assignment System  </p>
		</div>
	</div>
	<!-- //Footer -->
