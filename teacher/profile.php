...
<head>
    ...
    <title>DCAS : Teacher Details</title>
...
$sql="SELECT tblcourse.ID,tblcourse.BranchName,tblcourse.CourseName,tblteacher.ID,tblteacher.EmpID,tblteacher.FirstName,tblteacher.LastName,tblteacher.MobileNumber,tblteacher.Email,tblteacher.Gender,tblteacher.Dob,tblteacher.CourseID,tblteacher.Religion,tblteacher.Address,tblteacher.Password,tblteacher.ProfilePic,tblteacher.JoiningDate from tblteacher join tblcourse on tblcourse.ID=tblteacher.CourseID where tblteacher.ID=$tid";
...
<img class="img-responsive" src="../admin/images/<?php  echo htmlentities($row->ProfilePic);?>" alt="" width="200" height="200"/>
 </div>
</div>
 <div class="col-lg-8">
